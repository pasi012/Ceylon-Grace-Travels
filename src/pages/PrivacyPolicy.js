        ...
        <div className="privacy-wrapper">
            ...
            <div className="privacy-container">
                ...
                <p className="privacy-text">
                    At Ceylon Grace Travels, we are committed to protecting the privacy and security of our clients’ personal information.
                ...
                <div className="privacy-contact">
                    ...
                    <p className="email">
                        📧 <a href="mailto:ceylongracetravels@gmail.com">ceylongracetravels@gmail.com</a>
                    </p>
                </div>
            </div>
        </div>
