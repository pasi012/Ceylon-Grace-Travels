            ...
            <section className="contact-info" data-aos="fade-up">
                <div className="info-grid">
                    <div className="info-card" data-aos="zoom-in">
                        ...
                        <h4>Address Line</h4>
                        <p>No : 80/A/3 Kithulampitiya.Uluvitike,<br />Galle.Srilanka.</p>
                    </div>
                    ...
                    <div className="info-card" data-aos="zoom-in">
                        ...
                        <h4>Mail Address</h4>
                        <p>ceylongracetravels@gmail.com</p>
                    </div>
                </div>
            </section>
                ...
                <div className="contact-form" data-aos="fade-left">
                    ...
                    <form
                        onSubmit={(e) => {
                            ...
                            window.location.href = `mailto:ceylongracetravels@gmail.com?subject=Message from ${name}&body=Name: ${name}%0D%0AEmail: ${email}%0D%0A%0D%0AMessage:%0D%0A${message}`;
                        }}
                    >
