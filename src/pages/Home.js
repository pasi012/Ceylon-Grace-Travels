...
function Home() {
  ...
  useEffect(() => {
    ...
    getDownloadURL(ref(storage, "about2.jpg")).then(setAbout2Url);
  }, []);
    ...
    <div className="home-container">
      ...
      <section className="about-section">
        ...
        <div className="about-left" data-aos="fade-right">
          ...
          <h2>Ceylon Grace Travels</h2>

          <p>
            Sri Lankan based locally owned company <strong>Ceylon Grace Travels</strong> specializes in handling
          ...
          <p className="about-footer">
            <i className="fa fa-map-marker-alt"></i> Start your Sri Lankan adventure with Ceylon Grace Travels.
        ...
        <div className="why-choose-container">
          ...
          <div className="why-choose-content">
            ...
            <div className="why-choose-buttons">
              <button className="primary-btn" onClick={() => navigate("/about")}>ABOUT Ceylon Grace Travels</button>
              <button className="outline-btn" onClick={() => navigate("/whyChooseUs")}>WHY Ceylon Grace Travels</button>
            </div>
          </div>
        </div>
      </section>
