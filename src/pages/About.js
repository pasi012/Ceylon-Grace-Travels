    ...
    return (
        <div>
            ...
            <section className="about-intro" data-aos="fade-up">
                <h4>Welcome To Ceylon Grace Travels</h4>
                <h2>Your Gateway To An Unforgettable Sri Lankan Journey</h2>

                <p className="intro-text">
                    At Ceylon Grace Travels, we are committed to creating unique,
            ...
            <section className="founder-section" data-aos="fade-up">
                <div className="founder-container">
                    ...
                    <div className="founder-details">
                        ...
                        <h3 className="company-name">Ceylon Grace Travels</h3>

                        <p className="founder-description">
                            My name is Ramesh Kumara, and I am the founder of this travel platform, created with the purpose of helping travelers discover the beauty, culture, and grace of Sri Lanka.
                        </p>

                        <p className="highlight-text">
                            With a strong passion for travel, hospitality, and serving people, I started this page to provide trustworthy guidance, inspiring travel ideas, and personalized support for anyone planning to explore our island. Whether you are looking for peaceful beaches, historical sites, adventure, nature escapes, or spiritual journeys, my goal is to make your experience smooth, meaningful, and unforgettable.
                        </p>

                        <ul className="founder-list">
                            <li>✔ Reliable and honest travel guidance.</li>
                            <li>✔ Beautiful destinations and practical information.</li>
                            <li>✔ Customized trip planning based on your interests.</li>
                        </ul>

                        <button
                            className="founder-btn"
                            onClick={() => window.location.href = "tel:0771087217"}
                        >
                            CALL NOW !
                        </button>
                    </div>
            ...
            <section className="team-section" data-aos="fade-up">
                ...
                <div className="team-container">
                    ...
                    <div className="team-card" data-aos="zoom-in">
                        ...
                        <h3 className="team-name">Ramesh Kumara</h3>
                    </div>
                    ...
                    <div className="team-card" data-aos="zoom-in">
                        ...
                        <h3 className="team-name">Ashan Lakshman</h3>
                    </div>
                    ...
                    <div className="team-card" data-aos="zoom-in">
                        ...
                        <h3 className="team-name">Manoj Adrial</h3>
                    </div>
                    ...
                    <div className="sl-accordion">
                        ...
                        >
                            ...
                            <div className="sl-accordion-body">
                                <p>
                                    Ceylon Grace Travels offers personalized travel plans tailored to your
            ...
            <section className="why-choose-section" data-aos="fade-up">
                ...
                <div className="why-choose-left">
                    <h3 className="why-title">Why Choose Ceylon Grace Travels?</h3>
                    ...
                    <a
                        href="mailto:ceylongracetravels@gmail.com"
                        className="why-btn"
                        onClick={(e) => e.stopPropagation()}   // <--- IMPORTANT
                    >
                        Contact us at ceylongracetravels@gmail.com
                    </a>
                </div>
                ...
                <div className="why-choose-right">
                    <img
                        ...
                        alt="Why Choose Ceylon Grace Travels"
